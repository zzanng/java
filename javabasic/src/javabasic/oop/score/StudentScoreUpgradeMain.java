...
//		StudentScoreUpgrade ss1 = new StudentScoreUpgrade("홍길동",100,90,80);
//		StudentScoreUpgrade ss2 = new StudentScoreUpgrade("강감찬",90,80,70);
//		StudentScoreUpgrade ss3 = new StudentScoreUpgrade("이순신",80,70,60);
//		
