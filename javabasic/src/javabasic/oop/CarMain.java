...
//		*****해쉬코드값=참조값이 같다는것은 메모리에 같은 곳에 있다는 것이고 메모리에 같은 곳에 있다는 것은 같은 객체라는 뜻.
		...
		Car car4 = new Car();
		System.out.println(car3.equals(car4));    //car3 ,4 의 참조값을 비교 .  => false나옴 
		
		car4.carCount =4;
		
		System.out.println(Car.carCount); //static은 객체없이도 호출가능 
