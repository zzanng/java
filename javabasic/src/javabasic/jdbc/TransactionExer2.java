...
public class TransactionExer2 {
	...
	public static void main(String[] args) {
		...
		BankAccount kang = new BankAccount(1, "강감찬", 0);
		...
		try {
			...
			if (wdResult > 0) {
				System.out.println(hong.getBaname() + "계좌에서 500원 출금완료");
			}

			int result = 100 / 0;

			int dfResult = TransactionExer2.deposit(kang, 500);
			if (dfResult > 0) {
				System.out.println(kang.getBaname() + "계좌에서 500원 입금완료");
			}
