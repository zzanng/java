...
public class ResultSetMataDataExer {
	...
	public static void main(String[] args) {
		...
		while (rs.next()) {
			System.out.println( rs.getInt("baid")+ ":"+ rs.getString("baname") +":"+ rs.getInt("bamoney"));
			
		}
		//ResultSetMetaData는 데이터의 구조정보를 가진 인터페이스
		//resultset 의 getmetadata() 메소드로 ResultSetMetaData객체생성 
